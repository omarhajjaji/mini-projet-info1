...
if(isset($_POST['ajouter_grp']))
{
  ...
  $sel=$conn->prepare("select code from groupe where code=? limit 1");
         ...
         if(count($tab)>0)
            ...
            $reponse = $conn->exec($req) or die("error");
            $erreur ="OK";
         }  
         echo $erreur;
...
<div class="container">
 <form id="myform" method="post" action="">
     ...
     <div class="form-group">
        ...
        <input type="int" id="nb_elevess" name="nb_eleves" class="form-control" required pattern="[1-24]{1}">
       </div>
